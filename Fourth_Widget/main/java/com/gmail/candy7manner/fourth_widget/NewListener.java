...
public class NewListener extends AppCompatActivity {

    EditText op1, op2;
    TextView tvResult;

//    OnFocusChangeListener:    포커스 변화가 발생했을때 호출되는 메소드
//    OnClickListener:          클릭 됐을 때 호출되는 메소드
//    OnEditorActionListener:   타이핑 완료 되었을때 호출되는 메소드

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.newListener);
